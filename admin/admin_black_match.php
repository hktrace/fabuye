        ...
        <div class="x-body">
            ...
            <table class="layui-table">
                ...
                <tbody>
                    ...
                    <?php foreach ($BLACKLIST['match'] as $key => $val): ?>	
                        ...
                        <tr>
                            ...
                            <?php if (!lsMobile()): ?>
                                ...
                                <td><?php echo $BLACKLIST['black'][$val['black']]['name']; ?></td>   
                            <?php endif ?> 
                            <td class="td-status">
        ...
        <script>
            ...
            function member_stop(obj, id) {
                ...
                if ($(obj).attr('title') === '停用') {
                    ...
                    layer.confirm('确认停用吗？', function (index) {
                        ...
                        $.ajax({
                            url: "admin.php",
                            data: {"type": "black_match_stop", "id": id},
                    ...
                    $.ajax({
                        url: "admin.php",
                        data: {"type": "black_match_start", "id": id},
                        type: "post", dataType: 'json',
                        beforeSend: function () {
                            layer.load(0);
                        },
            ...
            function member_del(obj, id) {
                layer.confirm('确认要删除吗？', function (index) {
                    ...
                    $.ajax({
                        url: "admin.php",
                        data: {"type": "black_match_del", "id": id},
                        type: "post", dataType: 'json',
                        beforeSend: function () {
                            layer.load(0);
                        },
        ...
        /*用户-删除 多选*/
            function delAll(argument) {
                ...
                layer.confirm('确认要删除吗？' + data, function (index) {
                    $.ajax({
                        url: "admin.php",
                        data: {"type": "black_match_del", "id": data},
                        type: "post", dataType: 'json',
                        beforeSend: function () {
                            layer.load(0);
                        },
