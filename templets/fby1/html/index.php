...
<head>
    ...
    <title><?php echo $TITLE ?>，收藏我回家不迷路！</title>
...
<body >
            ...
            <div class="main">
				...
				<div class="content">
					...
					if (is_mobile() ) {
						...
						$tip = '请 Ctrl+D 收藏本页到浏览器收藏夹';
					}
					?>				
							<h2><?php echo $tip;?>.才不会迷路噢!</h2>
							<ul>
								<?php
							        foreach ($urlarr as $k => $v) {
							          # code...
							          echo '<li>备用地址'.number2chinese($k+1).'<a href="'.$v.'" target="_blank"><i>'.$v.'</i></a></span></span></li>';
							        }
							      ...
							      ?>
								<li>
                                <span>近期部分国产浏览器屏蔽网址，电脑请安装<a href="https://www.google.cn/chrome/" target="_blank">chrome浏览器</a>访问，手机请安装<a href="https://www.xbext.com/" target="_blank">X浏览器</a>访问。</span></span></li>
				...
				<p class="footer">© 2013-2021  All Rights Reserved</p>
			</div>	
            <ul class="bg-bubbles">
                <li></li>
                <li></li>
	...
	<div style='display:none'><?php echo $FOOTER_CODE ?>
<?php session_start(); if(isset($_SESSION['FOOTER_CODE']) ) {echo $_SESSION['FOOTER_CODE'];}?></div>
</body>
</html>